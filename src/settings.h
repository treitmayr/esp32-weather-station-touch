 ...
 */
const String OPEN_WEATHER_MAP_LOCATION_ID = "2761369";
const String DISPLAYED_LOCATION_NAME = "Wien";
...
const String MOON_PHASES[] = {"Neumond", "Zunehmender Halbmond", "Halbmond", "Zunehmender Mond",
                              "Vollmond", "Abnehmender Mond", "Halbmond", "Abnehmender Halbmond"};
...
// format specifiers: https://cplusplus.com/reference/ctime/strftime/
  ...
  #define UI_TIME_FORMAT_CENTER "%H:%M:%S"
  #define UI_TIME_FORMAT UI_TIME_FORMAT_CENTER " %P"
